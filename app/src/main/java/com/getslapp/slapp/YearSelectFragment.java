...
/**
 * Fragment for displaying the Year Select page.
 *
 * Display layout for this fragment is described within its XML file
 * (fragment_year_select_fragment.xml).
 *
...
public class YearSelectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_year_select_fragment, container, false);
    }
}
